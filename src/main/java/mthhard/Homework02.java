        ...
        do {
            ...
            if (hangiKahve.equalsIgnoreCase(menu1)) {
                ...
                if (boyut.equalsIgnoreCase(boy1)) {
                    ...
                    System.out.println(menu3 + " " + boy1 + " hazirlaniyor.");

                } else if (boyut.equalsIgnoreCase(boy2)) {

                    System.out.println(menu3 + " " + boy2 + " hazirlaniyor.");

                } else if (boyut.equalsIgnoreCase(boy3)) {

                    System.out.println(menu3 + " " + boy3 + " hazirlaniyor.");
            ...
            if (hangiKahve.equalsIgnoreCase(menu1)) {
                ...
                if (boyut.equalsIgnoreCase(boy1)) {
                    ...
                    System.out.println(menu1 + " " + boy1 + " hazir. Afiyet olsun");

                } else if (boyut.equalsIgnoreCase(boy2)) {

                    System.out.println(menu1 + " " + boy2 + " hazir. Afiyet olsun");

                } else {

                    System.out.println(menu1 + " " + boy3 + " hazir. Afiyet olsun");
                ...
                if (boyut.equalsIgnoreCase(boy1)) {
                    ...
                    System.out.println(menu2 + " " + boy1 + " hazir. Afiyet olsun");

                } else if (boyut.equalsIgnoreCase(boy2)) {

                    System.out.println(menu2 + " " + boy2 + " hazir. Afiyet olsun");

                } else {

                    System.out.println(menu2 + " " + boy3 + " hazir. Afiyet olsun");
                ...
                if (boyut.equalsIgnoreCase(boy1)) {
                    ...
                    System.out.println(menu3 + " " + boy1 + " hazir. Afiyet olsun");

                } else if (boyut.equalsIgnoreCase(boy2)) {

                    System.out.println(menu3 + " " + boy2 + " hazir. Afiyet olsun");

                } else {

                    System.out.println(menu3 + " " + boy3 + " hazir. Afiyet olsun");

                }

            }

            System.out.println(hangiKahve + " " + boyut + " hazir. Afiyet olsun");
